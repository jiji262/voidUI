...
const ProfileCard = () => {
  return (
    <div className="max-w-md mx-auto bg-white border-2 border-black rounded-lg p-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-center">
      ...
      <div className="flex justify-center gap-3 mb-6">
        <button className="w-10 h-10 bg-blue-300 rounded-full flex items-center justify-center border-2 border-black hover:bg-blue-400 transition-colors">
          <TwitterIcon className="h-4 w-4" />
        </button>
        <button className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center border-2 border-black hover:bg-gray-400 transition-colors">
