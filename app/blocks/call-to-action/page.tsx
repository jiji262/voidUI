...
const SimpleCTA = () => {
  return (
    <div className="max-w-4xl mx-auto bg-white border-2 border-black rounded-lg p-12 text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
    ...
    <div className="max-w-6xl mx-auto bg-white border-2 border-black rounded-lg p-12 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          <div className="aspect-square bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg flex items-center justify-center border-2 border-black">
            <img
...
const UrgencyCTA = () => {
  return (
    <div className="max-w-4xl mx-auto bg-gradient-to-r from-yellow-100 to-orange-100 border-2 border-black rounded-lg p-12 text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      <div className="inline-flex items-center gap-2 bg-yellow-300 px-4 py-2 rounded-full text-sm font-medium mb-6 border-2 border-black">
