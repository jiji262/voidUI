...
const blockCategories = {
  application: [
    ...
    },
    {
      ...
      variantColor: "bg-yellow-300",
      customContent: (
        <div className="w-16 h-20 bg-white border-2 border-black rounded shadow-sm flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {blockCategories.application.map((category) => (
              <Link key={category.href} href={category.href}>
                <div className="group bg-white border-2 border-black rounded-lg overflow-hidden hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-200">
                  ...
                  <div className="p-4">
                    ...
                    <span className={`inline-block px-2 py-1 text-xs font-medium text-black rounded ${category.variantColor}`}>
                      {category.variants}
                    </span>
                  </div>
                </div>
