...
const FeaturedArticle = () => {
 return (
 <div className="max-w-6xl mx-auto bg-white border-2 border-black overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
 ...
 <span className="bg-yellow-300 text-black px-3 py-1 text-sm font-medium border-2 border-black">
 Featured
 </span>
 </div>
 </div>
 ...
 <span className="bg-blue-100 text-blue-800 px-3 py-1 text-sm font-medium border border-blue-300">
 Technology
 </span>
...
const ArticleGrid = () => {
 ...
 <div key={index} className="bg-gray-50 border-2 border-black overflow-hidden">
 ...
 />
 <span className="absolute top-3 left-3 bg-blue-100 text-blue-800 px-2 py-1 text-xs font-medium border border-blue-300">
 {article.category}
 </span>
 </div>
 <div className="p-6">
