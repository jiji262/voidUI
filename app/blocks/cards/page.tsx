...
const ProductCard01 = () => (
  <div className="max-w-sm mx-auto bg-white border-2 border-black rounded-lg overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
  ...
  <div className="max-w-sm mx-auto bg-white border-2 border-black rounded-lg overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
    <div className="p-6">
      ...
      <div className="flex gap-2 flex-wrap">
        <Badge variant="secondary" className="bg-blue-100 text-blue-800 border border-blue-300">React</Badge>
        <Badge variant="secondary" className="bg-blue-100 text-blue-800 border border-blue-300">TypeScript</Badge>
        <Badge variant="secondary" className="bg-green-100 text-green-800 border border-green-300">Node.js</Badge>
      </div>
    </div>
  </div>
);`;
  ...
  <div className="max-w-sm mx-auto bg-white border-2 border-black rounded-lg overflow-hidden shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
    <div className="p-6">
      ...
      <div className="flex -space-x-2 mb-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="relative w-8 h-8 border-2 border-white rounded-full overflow-hidden">
            <Image
        ...
        <div className="w-8 h-8 bg-gray-200 border-2 border-white rounded-full flex items-center justify-center text-xs font-bold">
          +1
        </div>
      </div>
