...
const ThreeColumnPricing = () => {
 ...
 {/* Professional Plan */}
 <div className="bg-black text-white border-2 border-black p-8 text-center relative">
 <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-yellow-300 text-black px-4 py-1 text-sm font-medium border-2 border-black">
 Most Popular
 </div>
...
const TwoColumnPricing = () => {
 ...
 {/* Yearly Plan */}
 <div className="bg-black text-white border-2 border-black p-8 text-center relative">
 <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-green-300 text-black px-4 py-1 text-sm font-medium border-2 border-black">
 Save 30%
 </div>
