...
export default function AffiliatePage() {
 ...
 <div className="w-20 h-20 bg-primary/20 flex items-center justify-center mx-auto mb-6">
 ...
 <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900 flex items-center justify-center mx-auto mb-4">
 ...
 <Card className="p-8 text-center">
 <div className="w-16 h-16 bg-yellow-100 dark:bg-yellow-900 flex items-center justify-center mx-auto mb-4">
