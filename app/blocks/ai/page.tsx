...
const AIChatInterface = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white border-2 border-black rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
      {/* Header */}
      <div className="border-b-2 border-black p-4 bg-gray-50">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-yellow-300 rounded-full flex items-center justify-center border-2 border-black">
      ...
      <div className="h-80 overflow-y-auto p-4 space-y-4">
        ...
        {isTyping && (
          <div className="flex justify-start">
            <div className="bg-gray-100 border-2 border-gray-300 px-4 py-2 rounded-lg">
      ...
      <div className="border-t-2 border-black p-4 bg-gray-50">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2 border-2 border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
